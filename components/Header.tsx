...
const Header: React.FC<HeaderProps> = ({ onOpenSettings, onToggleMenu, onToggleImmersive }) => {
  ...
  return (
    <header className="h-20 w-full flex items-center justify-between px-6 flex-shrink-0 z-40 relative bg-white/90 border-b-[3px] border-black backdrop-blur-md">
       {/* Left: Logo & Title */}
       <div className="flex items-center gap-4">
          ...
          {/* Logo - Replaced with Sparkle Icon from user photo */}
          <div className="w-12 h-12 border-[3px] border-black flex items-center justify-center relative bg-white shadow-[3px_3px_0_#000] p-1">
             <svg viewBox="0 0 64 64" fill="currentColor" className="w-full h-full text-[#4A493E]">
                ...
                <path d="M48 12V24M42 18H54" stroke="currentColor" strokeWidth="4" stroke-linecap="round" />
             </svg>
             {/* Tiny accent */}
          ...
          <div className="flex flex-col leading-none select-none">
            ...
            <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono text-gray-800 font-bold tracking-[0.3em] uppercase">PROJECT</span>
