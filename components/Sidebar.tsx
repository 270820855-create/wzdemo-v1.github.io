...
import { Category, PetSkinId, GameId, NavLink } from '../types';
        ...
        <div className={`mb-8 transition-all duration-300 ${isCompact ? 'px-2 flex justify-center' : 'px-5'}`}>
            {isCompact ? (
                ...
                <div className="relative group select-none">
                    ...
                    <div className="absolute top-0 -right-2 text-[10px] font-mono font-bold text-gray-800 transform rotate-90 origin-top-right">v1.0</div>
                    ...
                    <div className="flex items-center justify-between mt-1 border-b-4 border-black pb-1">
                        ...
                        <span className="font-apple text-xs font-bold text-gray-600">菜单</span>
                    </div>
                </div>
            )}
        </div>
                ...
                return (
                    <button
                        ...
                        className={`
                            ...
                            ${isActive 
                                ? 'bg-cyber-lime border-black shadow-[4px_4px_0_#FF003C] translate-x-1 z-10 text-black' 
                                : 'bg-white text-gray-900 hover:bg-gray-100 hover:border-black hover:shadow-[4px_4px_0_#00F0FF] hover:-translate-y-0.5'
                            }
                        ...
                        {!isCompact && (
                            <div className="flex flex-col items-start leading-none relative z-10 w-full overflow-hidden">
                                ...
                                <div className="flex items-center gap-2 mt-0.5 opacity-60">
                                    ...
                                    <div className={`h-[1px] flex-1 ${isActive ? 'bg-black' : 'bg-gray-600 group-hover:bg-black'}`}></div>
                ...
                {isCompact ? (
                    <div className="flex flex-col gap-3">
                         ...
                         <button 
                            ...
                            className={`w-full aspect-square border-[3px] border-black flex items-center justify-center shadow-[3px_3px_0_#000] transition-colors ${isPetVisible ? 'bg-jinx-pink text-white' : 'bg-white text-gray-600'}`}
                        >
                    ...
                    <>
                        <div className="relative group">
                             ...
                             <div className="border-[3px] border-black bg-white p-3 shadow-[4px_4px_0_#000] relative">
                                 ...
                                 <div className="flex flex-wrap gap-2">
                                     {BUILT_IN_GAMES.map((game) => (
                                         <button
                                            ...
                                            className={`
                                                relative px-3 py-1.5 border-[2px] border-black transition-all active:translate-y-0.5 active:shadow-none
                                                font-apple font-black text-xs uppercase tracking-tighter
                                                ${game.color} hover:bg-black hover:text-white shadow-[2px_2px_0_#000]
                        ...
                        <div className="relative">
                             <div className="flex justify-between items-center mb-1 pl-1">
                                 ...
                                 <button 
                                    onClick={(e) => { e.stopPropagation(); onTogglePetVisibility(); }}
                                    className={`text-[10px] font-bold border border-black px-1.5 py-0.5 hover:bg-black hover:text-white transition-colors bg-white ${!isPetVisible ? 'line-through opacity-50' : ''}`}
                                 >
                                     {isPetVisible ? 'ON' : 'OFF'}
                                 </button>
                             </div>
